...
public class OldGoodsSaleStatisticsActivity extends BaseActivity implements View.OnClickListener {
    private DrawerLayout drawerLayout;

    private TextView user;
    private TextView numCount, priceCount;
    private TextView goodsClassType, vipPhone, receiptCode, saleTime;
    private RadioGroup payChip;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_goods_sale_statistics);
        ...
        viewModel.getQuerySaleResult().observe(this, new Observer<OperateResult>() {
            ...
            public void onChanged(OperateResult operateResult) {
                ...
                if (operateResult.getError() != null) {
                    BruceDialog.showPromptDialog(OldGoodsSaleStatisticsActivity.this,
    ...
    private void showSalespersonDialog() {
        BruceDialog.showSingleChoiceDialog(R.string.employees, OldGoodsSaleStatisticsActivity.this, MyKeeper.getInstance().getEmployeesName(), new BruceDialog.OnChoiceItemListener() {
            @Override
