...
import com.nicolas.shebangscashier.ui.cash.OldGoodsSaleStatisticsActivity;
import com.nicolas.shebangscashier.ui.cash.ReturnGoodsActivity;
...
//        content.add(new ModuleNavigation(false, MyApp.getInstance().getString(R.string.nav_cashier_vip_query), R.drawable.ic_vip_query, null));
        ...
        content.add(new ModuleNavigation(false, MyApp.getInstance().getString(R.string.nav_cashier_old_sales_query), R.drawable.ic_sales_old, OldGoodsSaleStatisticsActivity.class));
...
//        content.add(new ModuleNavigation(false, MyApp.getInstance().getString(R.string.nav_cashier_remittance), R.drawable.ic_remittance, null));
        content.add(new ModuleNavigation(false, MyApp.getInstance().getString(R.string.nav_cashier_refunds), R.drawable.ic_refunds, ReturnGoodsActivity.class));
    }
