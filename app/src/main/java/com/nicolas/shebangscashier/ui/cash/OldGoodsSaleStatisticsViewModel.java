...
public class OldGoodsSaleStatisticsViewModel extends ViewModel {
    private List<NewGoodsSaleStatistics> statistics;
    private float saleTotalPrice;
    private int saleNum;

    private OldGoodsSaleStatisticsCondition condition;
    ...
    public OldGoodsSaleStatisticsCondition getCondition() {
        return condition;
    }
    ...
    public class OldGoodsSaleStatisticsCondition {
