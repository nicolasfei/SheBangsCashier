package com.nicolas.shebangscashier.notice;
...
public class NoticeViewModel extends ViewModel {
    ...
    public void advertNoticeLocalInit() {
        ...
        bitmaps.add(BitmapFactory.decodeResource(MyApp.getInstance().getResources(), R.mipmap.advert1));
        bitmaps.add(BitmapFactory.decodeResource(MyApp.getInstance().getResources(), R.mipmap.advert2));
        bitmaps.add(BitmapFactory.decodeResource(MyApp.getInstance().getResources(), R.mipmap.advert3));
