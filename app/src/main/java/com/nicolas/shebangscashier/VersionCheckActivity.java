...
import com.nicolas.shebangscashier.ui.login.LoginActivity;
...
public class VersionCheckActivity extends AppCompatActivity {
            ...
            public void onChanged(OperateResult operateResult) {
                if (operateResult.getSuccess() != null) {
                    ...
                    if (msg.what == 1) {   //新版本发布
                        ...
                        viewModel.downNewVersionApp("http://p-updatecashier.scdawn.com/cashier.apk");
                    } else {
                        dismissChecking();
                        jumpToLoginActivity();
                    }
    ...
    private void installApp(String apkPath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri uri = FileProvider.getUriForFile(this, MyApp.getInstance().getPackageName() + ".fileProvider", apk);
